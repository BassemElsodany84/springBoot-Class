...
import com.soapassion.springboot.demo.github.GithubClient;
import com.soapassion.springboot.demo.github.RepositoryEvent;
...
public class EventsController {
    ...
    public ResponseEntity<RepositoryEvent[]> fetchEvents(@PathVariable String projectName) {
        GithubProject project = this.repository.getProjectByRepoName(projectName);
        if (project == null) {
